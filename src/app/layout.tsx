...
export const metadata: Metadata = {
  title: "Arbuz - AI PWA App & Banner Generator for Traffic Arbitrage",
  description: "Generate offer-based PWA apps and high-converting ad banners in seconds with AI. Credit-based pricing, referral rewards, and powerful analytics for traffic arbitrage professionals.",
  keywords: "traffic arbitrage, PWA generator, ad banner creator, AI marketing tools, arbitrage software",
  metadataBase: new URL("https://arbuz.app"),
  alternates: {
    canonical: "https://arbuz.app"
  },
  openGraph: {
    title: "Arbuz - AI PWA App & Banner Generator",
    description: "Create profitable PWA campaigns in seconds with AI. Earn 30% lifetime commissions through our referral program.",
    type: "website",
    siteName: "Arbuz",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32SiMkwDFagCJqdtr8SgryeO9Cj/uploaded-1763724696065-pxryaew3.jpg",
      alt: "Arbuz AI Dashboard"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "Arbuz - AI Traffic Arbitrage Tools",
    description: "Generate PWA apps and banners in seconds. Earn recurring commissions with our referral program.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32SiMkwDFagCJqdtr8SgryeO9Cj/uploaded-1763724696065-pxryaew3.jpg"]
  },
  robots: {
    index: true,
    follow: true
